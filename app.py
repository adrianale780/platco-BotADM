    ...
    try:
       ...
       # 7. GUARDAR (CON ESCUDO DE SEGURIDAD)
        ...
        try:
            ...
            # Intentamos cerrar, pero si falla no queremos que rompa el flujo principal
            try:
                wb.close()
            except Exception:
                pass
            ...
            # Si es el error del descriptor, igual devolvemos éxito porque el archivo se grabó
